...
class VL6180X:
    ...
    def default_settings(self):
        ...
        self.set_register(self.__VL6180X_FIRMWARE_RESULT_SCALER, 0x01) # 0x01
    ...
    def get_distance(self):
        ...
        return 3*distance  #scaling set to 3 adddress register #0097 #fd 1x, 7f 2x, 54 3x scaling
